...
protocol ScanQRViewControllerDelegate: PaymentRequestResolver, ViewControllerDismissable {
  ...
  func viewControllerDidScan(_ viewController: UIViewController, qrCode: QRCode, walletTransactionType: WalletTransactionType, fallbackViewModel: SendPaymentViewModel?)
...
extension ScanQRViewController: AVCaptureMetadataOutputObjectsDelegate {
  ...
  func metadataOutput(_ output: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection) {
    ...
    if qrCode.paymentRequestURL != nil {
      coordinationDelegate?.viewControllerDidScan(self, qrCode: qrCode, walletTransactionType: .onChain, fallbackViewModel: self.fallbackPaymentViewModel)
