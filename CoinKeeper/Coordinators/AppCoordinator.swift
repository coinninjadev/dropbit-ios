...
class AppCoordinator: CoordinatorType {
  ...
  func continueSetupFlow() {
    ...
    case .verifyDevice:   startDeviceVerificationFlow(userIdentityType: .phone, shouldOrphanRoot: true, isInitialSetupFlow: true)
  ...
  func startDeviceVerificationFlow(userIdentityType type: UserIdentityType, shouldOrphanRoot: Bool, isInitialSetupFlow: Bool) {
    func performFunction() {
